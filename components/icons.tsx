...
export const BarChartIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" x2="12" y1="20" y2="10" /><line x1="18" x2="18" y1="20" y2="4" /><line x1="6" x2="6" y1="20" y2="16" /></svg>
);
...
export const UserIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>
);
export const PuzzleIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19.439 7.852c-2.102 0-3.807 1.706-3.807 3.807 0 .602.14 1.174.39 1.684l-2.34 2.34a3.79 3.79 0 0 1-1.684-.39c-2.102 0-3.807 1.705-3.807 3.807s1.705 3.807 3.807 3.807 3.807-1.705 3.807-3.807a3.79 3.79 0 0 1-.39-1.684l2.34-2.34c.51.25 1.082.39 1.684.39 2.102 0 3.807-1.705 3.807-3.807s-1.705-3.807-3.807-3.807zm0 6.113c-1.27 0-2.306-1.036-2.306-2.306s1.036-2.306 2.306-2.306 2.306 1.036 2.306 2.306-1.036 2.306-2.306 2.306z"/><path d="M11.644 15.455c-1.27 0-2.306-1.036-2.306-2.306s1.036-2.306 2.306-2.306 2.306 1.036 2.306 2.306-1.036 2.306-2.306 2.306z"/><path d="M4.561 4.561c0-2.102 1.706-3.807 3.807-3.807s3.807 1.705 3.807 3.807v0c0 1.27-1.035 2.306-2.306 2.306-1.113 0-2.06-.79-2.25-1.838a2.53 2.53 0 0 0-1.026.478l-2.34 2.34a3.79 3.79 0 0 1-.39-1.684c0-2.102-1.705-3.807-3.807-3.807z"/></svg>
);
...
export const ArrowUpRightIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M7 17l9.2-9.2M17 17V7H7"/></svg>
);
export const ArrowDownRightIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M7 7l9.2 9.2M17 7v10H7"/></svg>
);
...
export const CreditCardIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="14" x="2" y="5" rx="2" /><line x1="2" x2="22" y1="10" y2="10" /></svg>
);
